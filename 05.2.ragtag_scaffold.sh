...
P_CONTIGS_IN="${ALL_RESULTS_DIR}/SL5.0_analyses_primary/05.1.ragtag_correct/ragtag.correct.fasta"
TEMP_DIR="${RAGTAG_SCAFFOLD_DIR}/${PBS_JOBID}_temp"
RAGTAG_SCAFFOLD_DIR="${ALL_RESULTS_DIR}/SL5.0_analyses_primary/05.2.ragtag_scaffold"
